...
public class dependency_inlining
{
    ...
    private readonly ServiceRegistry theServices = new();
    ...
    public void try_single_handler_one_singleton_arg()
    {
        ...
        theCode.ShouldContain(
            "var singletonArgMethod = new Lamar.Testing.IoC.Acceptance.SingletonArgMethod(_messageTracker);");
    }
    ...
    public void try_single_handler_two_singleton_arg()
    {
        ...
        theCode.ShouldContain(
            "var multipleArgMethod = new Lamar.Testing.IoC.Acceptance.MultipleArgMethod(_messageTracker, _widget);");
    }
    ...
    public void try_single_handler_two_container_scoped_args()
    {
        ...
        theCode.ShouldContain(
            "var multipleArgMethod = new Lamar.Testing.IoC.Acceptance.MultipleArgMethod(messageTracker, inline_widget);");
    }
    ...
    public void try_single_handler_two_container_scoped_args_one_disposable()
    {
        ...
        theCode.ShouldContain("var messageTracker = new Lamar.Testing.IoC.Acceptance.MessageTracker();");
        theCode.ShouldContain(
            "var multipleArgMethod = new Lamar.Testing.IoC.Acceptance.MultipleArgMethod(messageTracker, disposedWidget);");
    }
    ...
    public void try_single_handler_two_container_scoped_args_both_disposable()
    {
        ...
        theCode.ShouldContain(
            "using var disposedMessageTracker = new Lamar.Testing.IoC.Acceptance.DisposedMessageTracker();");
        theCode.ShouldContain("using var disposedWidget = new Lamar.Testing.IoC.Acceptance.DisposedWidget();");
        theCode.ShouldContain(
            "var multipleArgMethod = new Lamar.Testing.IoC.Acceptance.MultipleArgMethod(disposedMessageTracker, disposedWidget);");
    }
    ...
    public void try_single_handler_one_transient_arg()
    {
        ...
        theCode.ShouldContain("var messageTracker = new Lamar.Testing.IoC.Acceptance.MessageTracker();");
        theCode.ShouldContain(
            "var singletonArgMethod = new Lamar.Testing.IoC.Acceptance.SingletonArgMethod(messageTracker);");
    }
    ...
    public void try_single_handler_one_transient_arg_that_is_disposable()
    {
        ...
        theCode.ShouldContain(
            "using var disposedMessageTracker = new Lamar.Testing.IoC.Acceptance.DisposedMessageTracker();");
        theCode.ShouldContain(
            "var singletonArgMethod = new Lamar.Testing.IoC.Acceptance.SingletonArgMethod(disposedMessageTracker);");
    }
    ...
    public void multiple_actions_using_the_same_transient()
    {
        ...
        theCode.ShouldContain(
            "var multipleArgMethod = new Lamar.Testing.IoC.Acceptance.MultipleArgMethod(_messageTracker, inline_widget2);");
    ...
    public void multiple_actions_using_the_same_scoped()
    {
        ...
        theCode.ShouldContain("var inline_widget = new Lamar.Testing.IoC.Acceptance.Widget();");
        theCode.ShouldContain(
            "var multipleArgMethod = new Lamar.Testing.IoC.Acceptance.MultipleArgMethod(_messageTracker, inline_widget);");
...
/*
    ...
    public void can_reduce_with_closed_generic_service_dependency()
    {
        ...
        theCode.ShouldContain(
            "var genericServiceUsingMethod = new Lamar.Testing.IoC.Acceptance.GenericServiceUsingMethod<string>();");
    ...
    public void can_reduce_with_array_dependency()
    {
        ...
        theCode.ShouldContain(
            "var widgetArray = new StructureMap.Testing.Widget.IWidget[]{redWidget, greenWidget, blueWidget};");
    ...
    public void use_registered_array_if_one_is_known()
    {
        ...
        includeType<HandlerWithArray>();
        theServices.AddSingleton(new IWidget[] { new BlueWidget(), new GreenWidget() });

        theCode.ShouldContain("public GeneratedClass(StructureMap.Testing.Widget.IWidget[] widgetArray)");
        theCode.ShouldContain(
            "var handlerWithArray = new Lamar.Testing.IoC.Acceptance.HandlerWithArray(_widgetArray);");
    }
    ...
    public void can_reduce_with_enumerable_dependency()
    {
        ...
        theCode.ShouldContain(
            "var widgetList = new System.Collections.Generic.List<StructureMap.Testing.Widget.IWidget>{redWidget, greenWidget, blueWidget};");
    }
    ...
    public void use_registered_enumerable_if_one_is_known()
    {
        ...
        theCode.ShouldContain(
            "public GeneratedClass(System.Collections.Generic.IEnumerable<StructureMap.Testing.Widget.IWidget> widgetIEnumerable)");
        theCode.ShouldContain(
            "var widgetEnumerableUser = new Lamar.Testing.IoC.Acceptance.WidgetEnumerableUser(_widgetIEnumerable);");
    }
    ...
    public void use_registered_list_if_one_is_known()
    {
        ...
        theServices.AddSingleton(new List<IWidget> { new BlueWidget(), new GreenWidget() });

        theCode.ShouldContain(
            "public GeneratedClass(System.Collections.Generic.List<StructureMap.Testing.Widget.IWidget> widgetList)");
    ...
    public void use_registered_Ilist_if_one_is_known()
    {
        ...
        theCode.ShouldContain(
            "public GeneratedClass(System.Collections.Generic.IList<StructureMap.Testing.Widget.IWidget> widgetIList)");
    ...
    public void use_registered_IReadOnlyList_if_one_is_known()
    {
        ...
        theCode.ShouldContain(
            "public GeneratedClass(System.Collections.Generic.IReadOnlyList<StructureMap.Testing.Widget.IWidget> widgetIReadOnlyList)");
        theCode.ShouldContain(
            "var widgetIReadOnlyListUser = new Lamar.Testing.IoC.Acceptance.WidgetIReadOnlyListUser(_widgetIReadOnlyList);");
    }
}
