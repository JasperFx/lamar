...
public class using_family_policies
{
    ...
    {
        var graph = ServiceGraph.For(_ => { _.Policies.OnMissingFamily<CustomMissingFamily>(); });
    ...
    {
        var container = Container.For(_ => { _.Policies.OnMissingFamily<CustomMissingFamily>(); });
